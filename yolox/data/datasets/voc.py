...
class VOCDetection(Dataset):
    ...
    def evaluate_detections(self, all_boxes, output_dir=None):
        ...
        """
        if(os.path.exists("./YOLOX_outputs/yolox_voc_s/eval.txt")):
            os.remove("./YOLOX_outputs/yolox_voc_s/eval.txt")
        print("results save to ./YOLOX_outputs/yolox_voc_s/eval.txt")
        with open("./YOLOX_outputs/yolox_voc_s/eval.txt","a") as _f:
            now = datetime.datetime.now()
            _f.write(datetime.datetime.strftime(now,'%Y-%m-%d %H:%M:%S')+"\n")
            _f.write("--------------------------------------------------------------"+"\n")
    ...
    def _do_python_eval(self, output_dir="output", iou=0.5):
        ...
        with open("./YOLOX_outputs/yolox_voc_s/eval.txt","a") as _f:
            ...
            _f.write("Eval IoU : {:.2f}".format(iou)+"\n")
            ...
            for i, cls in enumerate(VOC_CLASSES):
                ...
                aps += [ap]
                _f.write("AP for {} = {:.4f}".format(cls, ap)+"\n")
